...
import tuskex.network.p2p.storage.mocks.ExpirableProtectedStoragePayloadStub;
import tuskex.network.p2p.storage.mocks.PersistableExpirableProtectedStoragePayloadStub;
import tuskex.network.p2p.storage.mocks.PersistableNetworkPayloadStub;
...
import static tuskex.network.p2p.storage.TestState.MAX_SEQUENCE_NUMBER_MAP_SIZE_BEFORE_PURGE;
