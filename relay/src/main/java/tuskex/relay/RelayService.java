...
class RelayService {
    ...
    private static final String ANDROID_DATABASE_URL = "https://tuskexnotifications.firebaseio.com";
    // Used in Tuskex app to check for success state. We won't want a code dependency just for that string so we keep it
    ...
    String sendAppleMessage(boolean isProduction, boolean isContentAvailable, String apsTokenHex, String encryptedMessage, boolean useSound) {
        ...
        payloadBuilder.setAlertBody("Tuskex notification");
    ...
    String sendAndroidMessage(String apsTokenHex, String encryptedMessage, boolean useSound) {
        ...
        Notification notification = new Notification("Tuskex", "Notification");
