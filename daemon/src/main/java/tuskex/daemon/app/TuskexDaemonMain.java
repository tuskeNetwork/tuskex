...
import tuskex.core.app.ConsoleInput;
import tuskex.core.app.CoreModule;
import tuskex.core.app.TuskexHeadlessAppMain;
import tuskex.daemon.grpc.GrpcServer;
...
@Slf4j
public class TuskexDaemonMain extends TuskexHeadlessAppMain {
    ...
    public static void main(String[] args) {
        ...
        while (keepRunning) {
            keepRunning = false;
            var daemon = new TuskexDaemonMain();
