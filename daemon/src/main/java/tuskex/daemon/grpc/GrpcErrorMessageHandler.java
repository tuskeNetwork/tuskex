...
import tuskex.proto.grpc.AvailabilityResultWithDescription;
...
/**
 * An implementation of tuskex.common.handlers.ErrorMessageHandler that avoids
 * an exception loop with the UI's tuskex.common.taskrunner framework.
 *
...
public class GrpcErrorMessageHandler implements ErrorMessageHandler {
    ...
    private String getAvailabilityResultDescription(AvailabilityResult proto) {
        return tuskex.core.offer.AvailabilityResult.fromProto(proto).description();
    }
