...
import tuskex.cli.opts.ArgumentList;
import tuskex.cli.opts.CancelOfferOptionParser;
import tuskex.cli.opts.CreateCryptoCurrencyPaymentAcctOptionParser;
import tuskex.cli.opts.CreateOfferOptionParser;
import tuskex.cli.opts.CreatePaymentAcctOptionParser;
import tuskex.cli.opts.GetAddressBalanceOptionParser;
import tuskex.cli.opts.GetBTCMarketPriceOptionParser;
import tuskex.cli.opts.GetBalanceOptionParser;
import tuskex.cli.opts.GetOffersOptionParser;
import tuskex.cli.opts.GetPaymentAcctFormOptionParser;
import tuskex.cli.opts.GetTradeOptionParser;
import tuskex.cli.opts.GetTradesOptionParser;
import tuskex.cli.opts.OfferIdOptionParser;
import tuskex.cli.opts.RegisterDisputeAgentOptionParser;
import tuskex.cli.opts.RemoveWalletPasswordOptionParser;
import tuskex.cli.opts.SendBtcOptionParser;
import tuskex.cli.opts.SetWalletPasswordOptionParser;
import tuskex.cli.opts.SimpleMethodOptionParser;
import tuskex.cli.opts.TakeOfferOptionParser;
import tuskex.cli.opts.UnlockWalletOptionParser;
import tuskex.cli.opts.WithdrawFundsOptionParser;
...
import static tuskex.cli.CurrencyFormat.toSatoshis;
import static tuskex.cli.Method.canceloffer;
import static tuskex.cli.Method.closetrade;
import static tuskex.cli.Method.confirmpaymentreceived;
import static tuskex.cli.Method.confirmpaymentsent;
import static tuskex.cli.Method.createcryptopaymentacct;
import static tuskex.cli.Method.createoffer;
import static tuskex.cli.Method.createpaymentacct;
import static tuskex.cli.Method.editoffer;
import static tuskex.cli.Method.failtrade;
import static tuskex.cli.Method.getaddressbalance;
import static tuskex.cli.Method.getbalance;
import static tuskex.cli.Method.getbtcprice;
import static tuskex.cli.Method.getfundingaddresses;
import static tuskex.cli.Method.getmyoffer;
import static tuskex.cli.Method.getmyoffers;
import static tuskex.cli.Method.getoffer;
import static tuskex.cli.Method.getoffers;
import static tuskex.cli.Method.getpaymentacctform;
import static tuskex.cli.Method.getpaymentaccts;
import static tuskex.cli.Method.getpaymentmethods;
import static tuskex.cli.Method.gettrade;
import static tuskex.cli.Method.gettrades;
import static tuskex.cli.Method.gettransaction;
import static tuskex.cli.Method.gettxfeerate;
import static tuskex.cli.Method.getunusedbsqaddress;
import static tuskex.cli.Method.getversion;
import static tuskex.cli.Method.lockwallet;
import static tuskex.cli.Method.sendbtc;
import static tuskex.cli.Method.settxfeerate;
import static tuskex.cli.Method.setwalletpassword;
import static tuskex.cli.Method.stop;
import static tuskex.cli.Method.takeoffer;
import static tuskex.cli.Method.unfailtrade;
import static tuskex.cli.Method.unlockwallet;
import static tuskex.cli.Method.unsettxfeerate;
import static tuskex.cli.Method.withdrawfunds;
import static tuskex.cli.opts.OptLabel.OPT_AMOUNT;
import static tuskex.cli.opts.OptLabel.OPT_HELP;
import static tuskex.cli.opts.OptLabel.OPT_HOST;
import static tuskex.cli.opts.OptLabel.OPT_PASSWORD;
import static tuskex.cli.opts.OptLabel.OPT_PORT;
import static tuskex.cli.opts.OptLabel.OPT_TX_FEE_RATE;
...
import static tuskex.cli.table.builder.TableType.CLOSED_TRADES_TBL;
...
import static tuskex.cli.table.builder.TableType.OPEN_TRADES_TBL;
import static tuskex.cli.table.builder.TableType.PAYMENT_ACCOUNT_TBL;
...
import static tuskex.proto.grpc.GetTradesRequest.Category.OPEN;
...
/**
 * A command-line client for the Tuskex gRPC API.
 */
@Slf4j
public class CliMain {
    ...
    private static void printHelp(OptionParser parser, @SuppressWarnings("SameParameterValue") PrintStream stream) {
        try {
            stream.println("Tuskex RPC Client");
            stream.println();
            stream.println("Usage: tuskex-cli [options] <method> [params]");
            stream.println();
            ...
            stream.println();
            stream.println("Method Help Usage: tuskex-cli [options] <method> --help");
            stream.println();
