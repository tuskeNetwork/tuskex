...
import static tuskex.cli.table.builder.TableBuilderConstants.COL_HEADER_BUYER_DEPOSIT;
import static tuskex.cli.table.builder.TableBuilderConstants.COL_HEADER_SELLER_DEPOSIT;
...
abstract class AbstractTradeListBuilder extends AbstractTableBuilder {
    ...
    @Nullable
    protected final Column<Long> colTuskexTradeFee;
    @Nullable
    ...
    AbstractTradeListBuilder(TableType tableType, List<?> protos) {
        ...
        this.colTuskexTradeFee = colSupplier.tuskexTradeDetailFeeColumn.get();
