...
import tuskex.cli.table.column.CryptoVolumeColumn;
import tuskex.cli.table.column.DoubleColumn;
import tuskex.cli.table.column.BooleanColumn;
import tuskex.cli.table.column.BtcColumn;
import tuskex.cli.table.column.Column;
import tuskex.cli.table.column.Iso8601DateTimeColumn;
import tuskex.cli.table.column.MixedTradeFeeColumn;
import tuskex.cli.table.column.SatoshiColumn;
import tuskex.cli.table.column.StringColumn;
import tuskex.proto.grpc.ContractInfo;
...
import static tuskex.cli.table.builder.TableBuilderConstants.COL_HEADER_AMOUNT;
import static tuskex.cli.table.builder.TableBuilderConstants.COL_HEADER_AMOUNT_IN_BTC;
import static tuskex.cli.table.builder.TableBuilderConstants.COL_HEADER_CURRENCY;
import static tuskex.cli.table.builder.TableBuilderConstants.COL_HEADER_DATE_TIME;
import static tuskex.cli.table.builder.TableBuilderConstants.COL_HEADER_DETAILED_AMOUNT;
import static tuskex.cli.table.builder.TableBuilderConstants.COL_HEADER_DETAILED_PRICE;
import static tuskex.cli.table.builder.TableBuilderConstants.COL_HEADER_DETAILED_PRICE_OF_CRYPTO;
import static tuskex.cli.table.builder.TableBuilderConstants.COL_HEADER_DEVIATION;
import static tuskex.cli.table.builder.TableBuilderConstants.COL_HEADER_MARKET;
import static tuskex.cli.table.builder.TableBuilderConstants.COL_HEADER_OFFER_TYPE;
import static tuskex.cli.table.builder.TableBuilderConstants.COL_HEADER_PAYMENT_METHOD;
import static tuskex.cli.table.builder.TableBuilderConstants.COL_HEADER_PRICE;
import static tuskex.cli.table.builder.TableBuilderConstants.COL_HEADER_STATUS;
import static tuskex.cli.table.builder.TableBuilderConstants.COL_HEADER_TRADE_CRYPTO_BUYER_ADDRESS;
import static tuskex.cli.table.builder.TableBuilderConstants.COL_HEADER_TRADE_BUYER_COST;
import static tuskex.cli.table.builder.TableBuilderConstants.COL_HEADER_TRADE_DEPOSIT_CONFIRMED;
import static tuskex.cli.table.builder.TableBuilderConstants.COL_HEADER_TRADE_DEPOSIT_PUBLISHED;
import static tuskex.cli.table.builder.TableBuilderConstants.COL_HEADER_TRADE_FEE;
import static tuskex.cli.table.builder.TableBuilderConstants.COL_HEADER_TRADE_ID;
import static tuskex.cli.table.builder.TableBuilderConstants.COL_HEADER_TRADE_MAKER_FEE;
import static tuskex.cli.table.builder.TableBuilderConstants.COL_HEADER_TRADE_PAYMENT_RECEIVED;
import static tuskex.cli.table.builder.TableBuilderConstants.COL_HEADER_TRADE_PAYMENT_SENT;
import static tuskex.cli.table.builder.TableBuilderConstants.COL_HEADER_TRADE_PAYOUT_PUBLISHED;
import static tuskex.cli.table.builder.TableBuilderConstants.COL_HEADER_TRADE_ROLE;
import static tuskex.cli.table.builder.TableBuilderConstants.COL_HEADER_TRADE_SHORT_ID;
import static tuskex.cli.table.builder.TableBuilderConstants.COL_HEADER_TRADE_TAKER_FEE;
import static tuskex.cli.table.builder.TableBuilderConstants.COL_HEADER_TRADE_WITHDRAWN;
...
import static tuskex.cli.table.column.CryptoVolumeColumn.DISPLAY_MODE.CRYPTO_VOLUME;
import static tuskex.cli.table.column.CryptoVolumeColumn.DISPLAY_MODE.BSQ_VOLUME;
import static tuskex.cli.table.column.Column.JUSTIFICATION.LEFT;
...
class TradeTableColumnSupplier {
    ...
    final Supplier<Column<Long>> tuskexTradeDetailFeeColumn = () -> {
