...
import static tuskex.cli.opts.OptLabel.OPT_FIXED_PRICE;
import static tuskex.cli.opts.OptLabel.OPT_MIN_AMOUNT;
...
public class CreateOfferOptionParser extends AbstractMethodOptionParser implements MethodOpts {
    ...
    final OptionSpec<String> currencyCodeOpt = parser.accepts(OPT_CURRENCY_CODE, "currency code (tsk|eur|usd|...)")
            .withRequiredArg();
