...
import static tuskex.cli.CryptoCurrencyUtil.apiDoesSupportCryptoCurrency;
...
import static tuskex.cli.opts.OptLabel.OPT_TRADE_INSTANT;
...
public class CreateCryptoCurrencyPaymentAcctOptionParser extends AbstractMethodOptionParser implements MethodOpts {
    ...
    final OptionSpec<String> currencyCodeOpt = parser.accepts(OPT_CURRENCY_CODE, "crypto currency code (tsk)")
            .withRequiredArg();
