...
import static tuskex.apitest.Scaffold.EXIT_FAILURE;
import static tuskex.apitest.Scaffold.EXIT_SUCCESS;
import static tuskex.apitest.config.ApiTestRateMeterInterceptorConfig.appendCallRateMeteringConfigPathOpt;
import static tuskex.apitest.config.ApiTestRateMeterInterceptorConfig.getTestRateMeterInterceptorConfig;
import static tuskex.apitest.config.ApiTestRateMeterInterceptorConfig.hasCallRateMeteringConfigPathOpt;
 ...
 * It has some uses:
 *
 * It can be used to print test scaffolding options:  tuskex-apitest --help.
 *
 * It can be used to smoke test your bitcoind environment:  tuskex-apitest.
 *
 * It can be used to run the regtest environment for release testing:
 * tuskex-test --shutdownAfterTests=false
 *
