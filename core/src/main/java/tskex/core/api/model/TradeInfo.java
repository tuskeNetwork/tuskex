...
import tuskex.core.api.model.builder.TradeInfoV1Builder;
...
import static tuskex.core.api.model.OfferInfo.toOfferInfo;
...
public class TradeInfo implements Payload {
    ...
    // The client cannot see tuskex.core.trade.Trade or its fromProto method.  We use the
    ...
    // Tuskex v1 trade protocol fields (some are in common with the BSQ Swap protocol).
    ...
    @Override
    public tuskex.proto.grpc.TradeInfo toProtoMessage() {
        return tuskex.proto.grpc.TradeInfo.newBuilder()
    ...
    public static TradeInfo fromProto(tuskex.proto.grpc.TradeInfo proto) {
        return new TradeInfoV1Builder()
