...
import tuskex.core.support.dispute.DisputeResult.SubtractFeeFrom;
...
public class CoreDisputesService {
    ...
    public CoreDisputesService(ArbitrationManager arbitrationManager,
                               @Named(FormattingUtils.BTC_FORMATTER_KEY) CoinFormatter formatter, // TODO: TSK?
                               KeyRing keyRing,
    ...
    public void closeDisputeTicket(DisputeManager disputeManager, Dispute dispute, DisputeResult disputeResult, ResultHandler resultHandler, FaultHandler faultHandler) {
        ...
        String amount = TuskexUtils.formatTsk(contract.getTradeAmount(), true);
        ...
        String textToSign = Res.get("disputeSummaryWindow.close.msg",
                ...
                amount,
                TuskexUtils.formatTsk(disputeResult.getBuyerPayoutAmountBeforeCost(), true),
                TuskexUtils.formatTsk(disputeResult.getSellerPayoutAmountBeforeCost(), true),
