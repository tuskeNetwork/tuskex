...
public class MobileNotificationService {
    ...
    private static final String TUSKEX_MESSAGE_IOS_MAGIC = "TuskexMessageiOS";
    private static final String TUSKEX_MESSAGE_ANDROID_MAGIC = "TuskexMessageAndroid";
    ...
    private void doSendMessage(String iv,
        ...
        switch (mobileModel.getOs()) {
            case IOS:
                msg = TUSKEX_MESSAGE_IOS_MAGIC;
                break;
            case IOS_DEV:
                msg = TUSKEX_MESSAGE_IOS_MAGIC;
                break;
            case ANDROID:
                msg = TUSKEX_MESSAGE_ANDROID_MAGIC;
                break;
            case UNDEFINED:
            default:
                throw new RuntimeException("No mobileModel OS set");
        ...
        ListenableFuture<String> future = executorService.submit(() -> {
            ...
            String result = httpClient.get(param, "User-Agent",
                    "tuskex/" + Version.VERSION + ", uid:" + httpClient.getUid());
