 ...
 */
@Slf4j
public class TskKeyImagePoller {

    private MoneroDaemon daemon;
    private long refreshPeriodMs;
    private List<String> keyImages = new ArrayList<String>();
    private Set<TskKeyImageListener> listeners = new HashSet<TskKeyImageListener>();
     ...
     * @param keyImages - key images to listen to
     */
    public TskKeyImagePoller(MoneroDaemon daemon, long refreshPeriodMs, String... keyImages) {
        looper = new TaskLooper(() -> poll());
        setDaemon(daemon);
     ...
     */
    public void addListener(TskKeyImageListener listener) {
     ...
     */
    public void removeListener(TskKeyImageListener listener) {
    ...
    public void poll() {
        ...
        if (!changedStatuses.isEmpty()) {
            for (TskKeyImageListener listener : new ArrayList<TskKeyImageListener>(listeners)) {
