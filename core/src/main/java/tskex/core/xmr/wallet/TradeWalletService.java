...
import tuskex.core.tsk.exceptions.SigningException;
import tuskex.core.tsk.exceptions.TransactionVerificationException;
import tuskex.core.tsk.exceptions.WalletException;
import tuskex.core.tsk.model.InputsAndChangeOutput;
import tuskex.core.tsk.model.PreparedDepositTxAndMakerInputs;
import tuskex.core.tsk.model.RawTransactionInput;
...
public class TradeWalletService {
    ...
    private RawTransactionInput getRawInputFromTransactionInput(@NotNull TransactionInput input) {
        ...
        // bitcoinSerialize(false) is used just in case the serialized tx is parsed by a tuskex node still using
