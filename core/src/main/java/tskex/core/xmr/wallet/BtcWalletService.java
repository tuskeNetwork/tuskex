...
import tuskex.core.tsk.exceptions.AddressEntryException;
import tuskex.core.tsk.exceptions.InsufficientFundsException;
...
public class BtcWalletService extends WalletService {
    ...
    public BtcWalletService(WalletsSetup walletsSetup,
        ...
        // TODO: set and use chainHeightProperty in TskWalletService
...
//            chainHeightProperty.set(walletsSetup.getChain().getBestChainHeight());
    ...
    public void resetAddressEntriesForPendingTrade(String offerId) {
        ...
        // to an external wallet directly in the last step of the trade, but the funds are in the Tuskex wallet anyway and
