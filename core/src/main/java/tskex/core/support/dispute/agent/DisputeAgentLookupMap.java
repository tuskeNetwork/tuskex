...
package tuskex.core.support.dispute.agent;
...
public class DisputeAgentLookupMap {
    ...
    // See also: https://tuskex.exchange/wiki/Finding_your_mediator
    @Nullable
    public static String getMatrixUserName(String fullAddress) {
        ...
        switch (fullAddress) {
            case "7hkpotiyaukuzcfy6faihjaols5r2mkysz7bm3wrhhbpbphzz3zbwyqd.onion:9999":
                return "leo816";
            case "wiztuskexzd7ku25di7p2ztsajioabihlnyp5lq5av66tmu7do2dke2tid.onion:9999":
                return "wiz";
            case "apbp7ubuyezav4hy.onion:9999":
                return "tuskex_knight";
    ...
    public static String getMatrixLinkForAgent(String onion) {
        ...
        // as a stopgap measure, replace unknown ones with a link to the Tuskex team
        String agentName = getMatrixUserName(onion).replaceAll(Res.get("shared.na"), "tuskex");
