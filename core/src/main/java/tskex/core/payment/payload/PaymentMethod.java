...
import tuskex.core.payment.CelPayAccount;
...
import tuskex.core.payment.ImpsAccount;
...
import tuskex.core.payment.NeftAccount;
import tuskex.core.payment.NequiAccount;
import tuskex.core.payment.PaxumAccount;
import tuskex.core.payment.PayseraAccount;
import tuskex.core.payment.PaytmAccount;
import tuskex.core.payment.PerfectMoneyAccount;
import tuskex.core.payment.PixAccount;
...
import tuskex.core.payment.RtgsAccount;
...
import tuskex.core.payment.TransferwiseUsdAccount;
...
public final class PaymentMethod implements PersistablePayload, Comparable<PaymentMethod> {
    ...
    private static final long DAY = Config.baseCurrencyNetwork() == BaseCurrencyNetwork.TSK_LOCAL ? TimeUnit.MINUTES.toMillis(1) :
                                    Config.baseCurrencyNetwork() == BaseCurrencyNetwork.TSK_STAGENET ? TimeUnit.MINUTES.toMillis(30) :
    ...
    private static final BigInteger DEFAULT_TRADE_LIMIT_VERY_LOW_RISK = TuskexUtils.tskToAtomicUnits(100);
    private static final BigInteger DEFAULT_TRADE_LIMIT_LOW_RISK = TuskexUtils.tskToAtomicUnits(50);
    private static final BigInteger DEFAULT_TRADE_LIMIT_MID_RISK = TuskexUtils.tskToAtomicUnits(25);
    private static final BigInteger DEFAULT_TRADE_LIMIT_HIGH_RISK = TuskexUtils.tskToAtomicUnits(12.5);
    ...
    public BigInteger getMaxTradeLimit(String currencyCode) {
        ...
        if (currencyCode.equals("SF"))
            return TuskexUtils.tskToAtomicUnits(4);
