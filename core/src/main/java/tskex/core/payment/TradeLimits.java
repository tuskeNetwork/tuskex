...
public class TradeLimits {
    private static final BigInteger MAX_TRADE_LIMIT = TuskexUtils.tskToAtomicUnits(96.0); // max trade limit for lowest risk payment method. Others will get derived from that.
    @Nullable
    @Getter
     ...
     *
     * @see tuskex.core.payment.payload.PaymentMethod
