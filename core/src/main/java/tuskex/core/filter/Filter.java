...
import tuskex.common.util.ExtraDataMapValidator;
...
public final class Filter implements ProtectedStoragePayload, ExpirablePayload {
    ...
    private final boolean preventPublicTskNetwork;
    private final List<String> tskNodes;
    ...
    private final List<String> tskFeeReceiverAddresses;
    ...
    public Filter(List<String> bannedOfferIds,
                  ...
                  boolean preventPublicTskNetwork,
                  List<String> tskNodes,
                  ...
                  List<String> tskFeeReceiverAddresses,
    ...
    public Filter(List<String> bannedOfferIds,
        ...
        this.preventPublicTskNetwork = preventPublicTskNetwork;
        ...
        this.tskFeeReceiverAddresses = tskFeeReceiverAddresses;
    ...
    public protobuf.StoragePayload toProtoMessage() {
        ...
        protobuf.Filter.Builder builder = protobuf.Filter.newBuilder().addAllBannedOfferIds(bannedOfferIds)
                ...
                .setPreventPublicTskNetwork(preventPublicTskNetwork)
                .addAllTskNodes(tskNodes)
                ...
                .addAllTskFeeReceiverAddresses(tskFeeReceiverAddresses)
    ...
    public static Filter fromProto(protobuf.Filter proto) {
        ...
        return new Filter(ProtoUtil.protocolStringListToList(proto.getBannedOfferIdsList()),
                ...
                proto.getPreventPublicTskNetwork(),
                ProtoUtil.protocolStringListToList(proto.getTskNodesList()),
                ...
                ProtoUtil.protocolStringListToList(proto.getTskFeeReceiverAddressesList()),
    ...
    public String toString() {
        return "Filter{" +
                ...
                ",\n     preventPublicTskNetwork=" + preventPublicTskNetwork +
                ",\n     tskNodes=" + tskNodes +
                ...
                ",\n     tskFeeReceiverAddresses=" + tskFeeReceiverAddresses +
