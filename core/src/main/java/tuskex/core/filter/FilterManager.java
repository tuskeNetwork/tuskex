...
import tuskex.common.config.ConfigFileEditor;
...
public class FilterManager {
    ...
    private static final String BANNED_TSK_NODES = "bannedTskNodes";
    ...
    public FilterManager(P2PService p2PService,
        ...
        publicKeys = useDevPrivilegeKeys ?
                ...
                List.of("0280c207a23a361cdab1d6f34ec65d39bbd681da7372358b0404a2a26717829bc5",
    ...
    private void onFilterAddedFromNetwork(Filter newFilter) {
        ...
        saveBannedNodes(BANNED_TSK_NODES, newFilter.getTskNodes());
        ...
        //TODO should be moved to client with listening on onFilterAdded
        if (newFilter.isPreventPublicTskNetwork() &&
                preferences.getMoneroNodesOptionOrdinal() == TskNodes.MoneroNodesOption.PUBLIC.ordinal()) {
    ...
    private void clearBannedNodes() {
        saveBannedNodes(BANNED_TSK_NODES, null);
