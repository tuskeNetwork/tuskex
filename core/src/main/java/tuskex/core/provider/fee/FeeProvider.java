...
package tuskex.core.provider.fee;
...
import tuskex.core.provider.FeeHttpClient;
import tuskex.core.provider.HttpClientProvider;
...
public class FeeProvider extends HttpClientProvider {
    ...
    public Tuple2<Map<String, Long>, Map<String, Long>> getFees() throws IOException {
        String json = httpClient.get("getFees", "User-Agent", "tuskex/" + Version.VERSION);
