...
import tuskex.common.util.Profiler;
...
@Slf4j
public abstract class ExecutableForAppWithP2p extends TuskexExecutable {
    ...
    public void gracefulShutDown(ResultHandler resultHandler) {
        ...
        try {
            if (injector != null) {
                    ...
                    injector.getInstance(P2PService.class).shutDown(() -> {
                        ...
                        injector.getInstance(WalletsSetup.class).shutDownComplete.addListener((ov, o, n) -> {
                            ...
                            PersistenceManager.flushAllDataToDiskAtShutdown(() -> {
                                ...
                                UserThread.runAfter(() -> System.exit(TuskexExecutable.EXIT_SUCCESS), 1);
                            });
                        });
                ...
                UserThread.runAfter(() -> {
                    resultHandler.handleResult();
                    System.exit(TuskexExecutable.EXIT_SUCCESS);
                }, 1);
            }
        } catch (Throwable t) {
            ...
            PersistenceManager.flushAllDataToDiskAtShutdown(() -> {
                ...
                UserThread.runAfter(() -> System.exit(TuskexExecutable.EXIT_FAILURE), 1);
            });
