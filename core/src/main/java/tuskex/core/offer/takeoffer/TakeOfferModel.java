...
package tuskex.core.offer.takeoffer;
...
import static tuskex.core.offer.OfferDirection.SELL;
...
import static tuskex.core.tsk.model.TskAddressEntry.Context.OFFER_FUNDING;
...
public class TakeOfferModel implements Model {
    ...
    // Mutable
    @Getter
    private TskAddressEntry addressEntry;
    @Getter
    ...
    @Getter
    private boolean isTskWalletFunded;
    @Getter
    ...
    public void initModel(Offer offer,
        ...
        this.addressEntry = tskWalletService.getOrCreateAddressEntry(offer.getId(), OFFER_FUNDING);
        validateModelInputs();
        ...
        this.takerFee = TuskexUtils.multiply(amount, offer.getTakerFeePct());
    ...
    private void updateBalance() {
        totalAvailableBalance = tskWalletService.getAvailableBalance();
        ...
        isTskWalletFunded = offerUtil.isBalanceSufficient(totalToPay, availableBalance);
    }
    ...
    public String toString() {
        return "TakeOfferModel{" +
                ...
                ", isTskWalletFunded=" + isTskWalletFunded + "\n" +
                '}';
    }
}
