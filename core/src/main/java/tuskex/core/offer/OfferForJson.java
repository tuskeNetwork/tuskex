    ...
    private void setDisplayStrings() {
        try {
            ...
            if (CurrencyUtil.isTraditionalCurrency(currencyCode)) {
                ...
                primaryMarketMinAmountDisplayString = TuskexUtils.formatTsk(getMinAmount()).toString();
                primaryMarketAmountDisplayString = TuskexUtils.formatTsk(getAmount()).toString();
                ...
                primaryMarketMinVolumeDisplayString = TuskexUtils.formatTsk(getMinAmount()).toString();
                primaryMarketVolumeDisplayString = TuskexUtils.formatTsk(getAmount()).toString();
            }
