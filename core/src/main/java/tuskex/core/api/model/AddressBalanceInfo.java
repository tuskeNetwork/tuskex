...
public class AddressBalanceInfo implements Payload {
    ...
    @Override
    public tuskex.proto.grpc.AddressBalanceInfo toProtoMessage() {
        return tuskex.proto.grpc.AddressBalanceInfo.newBuilder()
                .setAddress(address)
                .setBalance(balance)
    ...
    public static AddressBalanceInfo fromProto(tuskex.proto.grpc.AddressBalanceInfo proto) {
