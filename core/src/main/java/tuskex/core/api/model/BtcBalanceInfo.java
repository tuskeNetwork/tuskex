...
public class BtcBalanceInfo implements Payload {
    ...
    @Override
    public tuskex.proto.grpc.BtcBalanceInfo toProtoMessage() {
        return tuskex.proto.grpc.BtcBalanceInfo.newBuilder()
    ...
    public static BtcBalanceInfo fromProto(tuskex.proto.grpc.BtcBalanceInfo proto) {
