...
import tuskex.core.api.model.builder.OfferInfoBuilder;
...
import static tuskex.common.util.MathUtils.exactMultiply;
import static tuskex.core.util.PriceUtil.reformatMarketPrice;
...
public class OfferInfo implements Payload {
    ...
    // The client cannot see tuskex.core.Offer or its fromProto method.  We use the lighter
    ...
    @Override
    public tuskex.proto.grpc.OfferInfo toProtoMessage() {
        tuskex.proto.grpc.OfferInfo.Builder builder = tuskex.proto.grpc.OfferInfo.newBuilder()
                .setId(id)
    ...
    public static OfferInfo fromProto(tuskex.proto.grpc.OfferInfo proto) {
        return new OfferInfoBuilder()
                .withId(proto.getId())
