...
import static tuskex.common.file.FileUtil.doesFileContainKeyword;
    ...
    public static void createZipFileOfLogs(String zipFilePath, String zipId, String fullTradeId) {
        try {
            ...
            paths.filter(Files::isRegularFile).forEach(externalTxtFile -> {
                try {
                    // always include tuskex.log; and other .log files if they contain the TradeId
                    if (externalTxtFile.getFileName().toString().equals("tuskex.log") ||
