...
public abstract class BuyerSendPaymentSentMessage extends SendMailboxMessageTask {
    ...
    protected TradeMailboxMessage getTradeMailboxMessage(String tradeId) {
        if (getReceiver().getPaymentSentMessage() == null) {
            ...
            String deterministicId = TuskexUtils.getDeterministicId(trade, PaymentSentMessage.class, getReceiverNodeAddress());
            ...
            try {
                ...
                byte[] sig = TuskexUtils.sign(processModel.getP2PService().getKeyRing(), messageAsJson);
