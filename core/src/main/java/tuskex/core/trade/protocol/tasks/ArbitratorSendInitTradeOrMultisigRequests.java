...
public class ArbitratorSendInitTradeOrMultisigRequests extends TradeTask {
    ...
    private void sendInitMultisigRequests() {
        ...
        String address = TuskexUtils.ARBITRATOR_ASSIGNS_TRADE_FEE_ADDRESS ? trade.getTskWalletService().getBaseAddressEntry().getAddressString() : TuskexUtils.getGlobalTradeFeeAddress();
