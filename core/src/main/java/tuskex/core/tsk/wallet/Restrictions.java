...
public class Restrictions {
    public static BigInteger MIN_TRADE_AMOUNT = TuskexUtils.tskToAtomicUnits(0.1);
    public static BigInteger MIN_BUYER_SECURITY_DEPOSIT = TuskexUtils.tskToAtomicUnits(0.1);
    ...
    public static BigInteger getMinRefundAtMediatedDispute() {
        if (MIN_REFUND_AT_MEDIATED_DISPUTE == null)
            MIN_REFUND_AT_MEDIATED_DISPUTE = TuskexUtils.tskToAtomicUnits(0.0005);
