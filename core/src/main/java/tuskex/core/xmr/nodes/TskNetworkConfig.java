...
public class TskNetworkConfig {
    private static final Logger log = LoggerFactory.getLogger(TskNetworkConfig.class);
    ...
    public TskNetworkConfig(WalletConfig delegate, NetworkParameters parameters, int socks5DiscoverMode,
            ...
            if (log.isWarnEnabled()) {
                ...
                if (parameters.equals(mainNetParams)) {
                    log.warn("You use the public Bitcoin network and are exposed to privacy issues " +
                            "caused by the broken bloom filters. See https://tuskex.exchange/blog/privacy-in-bitsquare/ " +
