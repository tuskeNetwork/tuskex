 ...
 */
@Slf4j
public abstract class TuskexDefaultCoinSelector implements CoinSelector {
    ...
    public TuskexDefaultCoinSelector(boolean permitForeignPendingTx) {
        this.permitForeignPendingTx = permitForeignPendingTx;
    }

    public TuskexDefaultCoinSelector() {
